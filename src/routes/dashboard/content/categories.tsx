...
import type { CategoryWithRelations, DisciplineWithRelations, CategoryInsert, CategoryUpdate, Profile } from '@/src/lib/shared/types/database'
...
export const Route = createFileRoute('/dashboard/content/categories')({
