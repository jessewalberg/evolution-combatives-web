...
export function QAManagementPage() {
    ...
    // Q&A is support_admin + super_admin only — see ROUTE_CONFIG.roleAccess
    if (!user || !profile?.admin_role || profile.admin_role === 'content_admin') {
        return (
            <div className="min-h-screen bg-background flex items-center justify-center">
                <div className="text-center max-w-md mx-auto p-8">
                    ...
                    <p className="text-muted-foreground mb-6">
                        Your account does not have permission to manage Q&A.
                    </p>
                    <button
