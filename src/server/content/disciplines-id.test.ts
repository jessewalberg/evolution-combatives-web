...
const GET = (request: Request, params: { id: string }) =>
  GETHandler({ request, params } as never)
const PUT = (request: Request, params: { id: string }) =>
  PUTHandler({ request, params } as never)
const DELETE = (request: Request, params: { id: string }) =>
  DELETEHandler({ request, params } as never)
